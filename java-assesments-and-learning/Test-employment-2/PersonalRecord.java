...
// personal record class. displays an employee's personal record
public class PersonalRecord implements ActionListener{
	...
	private void getText(){
		...
		try {
			if(resultSet.next()){
				...
				surnameTextField.setText(resultSet.getString("surname"));
				...
				townOrCityTextField.setText(resultSet.getString("townOrCity"));
				countyTextField.setText(resultSet.getString("county"));
				postcodeTextField.setText(resultSet.getString("postcode"));
				telephoneTextField.setText(resultSet.getString("telephone"));
				mobileTextField.setText(resultSet.getString("mobile"));
				nextOfKinTextField.setText(resultSet.getString("nextOfKin"));
				nextOfKinMobileTextField.setText(resultSet.getString("nextOfKinMobile"));
			}
	...
	private void buildPanel(SpringLayout layout){
		...
		header = new JLabel();
		if(id!=0){
			header.setText("Personal record for staff ID " + id);
		}else{
			header.setText("Create new personal record");
		}
		panel.add(header);
		...
		layout.putConstraint(SpringLayout.NORTH, nameLabel, 30, SpringLayout.NORTH, header);
		layout.putConstraint(SpringLayout.WEST, nameLabel, 160, SpringLayout.WEST, container);
		//position the nameTextField
		layout.putConstraint(SpringLayout.NORTH, nameTextField, 30, SpringLayout.NORTH, header);
	...
	// checks that the entered passwords match each other
